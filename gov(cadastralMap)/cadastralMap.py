...
class CadastralMapDownloadPDF():
    ...
    def cadastral_map(self, cadastral_address, lidong_number_address, address_bun, address_ho):
        ...
        # 번지&호 입력
        locator_type = 'ID'
        locator_name = '지적도임야도등본교부신청서_IN-지적도임야도등본교부신청서_신청토지소재지_주소정보_상세주소_번지'
        self.element_input_text(delay, locator_type, locator_name, address_bun)
        locator_name = '지적도임야도등본교부신청서_IN-지적도임야도등본교부신청서_신청토지소재지_주소정보_상세주소_호'
