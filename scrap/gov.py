...
class GovDownloadPDF():
    ...
    # def eum(self, cadastral_address, lidong_number_address, address_bun, address_ho):
    #     print(cadastral_address)
    #     print(lidong_number_address)
    #     print(address_bun)
    #     print(address_ho)
    ...
    #     # 페이지 이동
    #     self.driver.get('https://www.gov.kr/mw/AA020InfoCappView.do?HighCtgCD=A09005&CappBizCD=15000000013&tp_seq=01')
    ...
    #     # 번지&호 입력
    #     self.driver.find_element_by_id('토지이용계획확인원신청서_IN-토지이용계획확인원신청서_입력항목_대상토지소재지_주소정보_상세주소_번지').send_keys(address_bun)
    #     self.driver.find_element_by_id('토지이용계획확인원신청서_IN-토지이용계획확인원신청서_입력항목_대상토지소재지_주소정보_상세주소_호').send_keys(address_ho)
